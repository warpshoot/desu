...
export const TONE_PRESETS = [
    // Coarse dots (4 variations) -> Changed to Fine (Light) as per request
    { id: 'coarse1', name: 'B1', type: 'fine', spacing: 9, dotSize: 1.5 },
    { id: 'coarse2', name: 'B2', type: 'fine', spacing: 7, dotSize: 1.5 },
    { id: 'coarse3', name: 'B3', type: 'fine', spacing: 5, dotSize: 1.5 },
    { id: 'coarse4', name: 'B4', type: 'fine', spacing: 4, dotSize: 1.5 },
